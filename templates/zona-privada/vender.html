...
<head>
    ...
    <meta name="description" content="Vender Bitcoin nunca ha sido tan fácil desde Perú, en Agente Bitcoin podrás realizar tus operaciones con mucha seguridad y confianza. Crea tu cuenta">
    <title>Vender Bitcoin | Zona de Miembros | Agente Bitcoin</title>
    <!-- css -->
    ...
    <!-- css vender -->
    <link rel="stylesheet" href="../css/zona-privada/vender.css">
    <link rel="stylesheet" href="../css/zona-privada/vender-responsive.css">
    <!-- FAVICON -->
...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <section class="op-vender">
                <div class="aviso">
                    <p>Ingresa tus cuentas de banco para poder realizarte las transferencias.</p>
                    <a href="#" title="ingresa-cuentas">Ingresa tus Cuentas Aquí</a>
                </div>
                <div class="titulo-vender">
                    <h1>Vender</h1>
                </div>
                <div class="box-vender">
                    <div class="precio-act">
                        ...
                        <div class="content-precio">
                            ...
                            <div class="vender-todo">
                                <input type="checkbox" name="vender-todo" id="vender-todo">
                                <p>Vender todo el saldo BTC</p>
                            </div>
                            ...
                            <div class="start-operacion"><a href="#">Iniciar Operación</a></div>
                            <!-- RESPONSIVE -->
                        ...
                        <div class="start-operacion-2"><a href="#">Iniciar Operación</a></div>
                    </div>
